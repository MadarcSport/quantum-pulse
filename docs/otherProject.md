...
import Lightroom2, { HDR_INTENSITY } from "./Lightroom2";
...
<Lightroom2 />
      ...
      {/* Keep F locked; model rotation is handled by pointer dragging. */}
      <OrbitControls
        makeDefault
        target={[0, 4, 0]}
        enableZoom={false}
...
const { nodes, materials } = useGLTF("/boardC7.glb");
