...
export function createElectricSweepMaterial2(baseMaterial, shaderRef) {
  const material = baseMaterial.clone();

  material.name = "ElectricSweepMaterial2";
  ...
  material.customProgramCacheKey = () => "electric-blue-sweep-material-2";
